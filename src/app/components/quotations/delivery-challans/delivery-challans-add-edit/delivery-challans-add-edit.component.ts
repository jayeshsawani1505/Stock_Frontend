...
export class DeliveryChallansAddEditComponent implements OnInit {
  ...
  populateForm(quotation: any): void {
    ...
    if (quotation.invoice_details && Array.isArray(quotation.invoice_details)) {
      const invoiceDetailsArray = this.QuotationForm.get('invoice_details') as FormArray;
      invoiceDetailsArray.clear();
      quotation.invoice_details.forEach((detail: any) => {
        ...
        invoiceDetailsArray.push(newRow);
      });
    }
  }
